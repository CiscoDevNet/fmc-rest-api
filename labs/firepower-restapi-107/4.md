# Performing access policy operations with the REST API

## GET

The following Python script is an example of a GET action performed against an access policy.
...
The following Python script is an example of a POST action performed against an access policy.
...
```
**Congratulations! You have completed "Firewall Management Center (FMC) access control policies"**
